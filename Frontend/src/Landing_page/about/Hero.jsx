    ...
    return ( 
        <div className="container">
            <div className="row p-5 mt-5 mb-5">
                  <h2 className="fs-4 text-center" >We pioneered the discount broking model in India.<br/>
Now, we are breaking ground with our technology.</h2>
          ...
          <p>
            over <span className="clint-count">1.6+ crore</span> clients place billions of orders every year
